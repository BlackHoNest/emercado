            ...
            <div class="d-slider1 overflow-hidden ">
               <ul  class="swiper-wrapper list-inline m-0 p-0 mb-2">
                  ...
                  <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="900">
                     <div class="card-body">
                        <div class="progress-widget">
                           <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-file-earmark-break-fill" viewBox="0 0 16 16">
                        ...
                        @foreach ($sellersbymunicipal as $sbm)
                           <tr>
                              <td>
                                 ...
                                 {{ ucwords($sbm->municipal) }}
                              </td>

                              @foreach ($totalsellerspending as $tsp)
                                 @if($sbm->account_id == $tsp->municipality)
                              ...
                              @foreach ($totalsellersverified as $tsv)
                                 @if($sbm->account_id == $tsv->municipality)
                  ...
                  <p class="mb-0">
                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-fill" viewBox="0 0 16 16">
                      ...
                      @foreach (Session::get('admin') as $admin)
                        Municipality of {{ ucwords($admin->municipal) }}
                      @endforeach  
                  </p>
               </div>
            </div>
