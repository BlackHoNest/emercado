                        ...
                        <tbody>
                            ...
                            @foreach ($pendingsellers as $pen)
                                <tr class='{{ $pen->seller_id }}'>
                                    ...
                                    <td>{{ ucwords($pen->citymunDesc) }}</td>
                                    <td>{{ ucwords($pen->brgyDesc) }}</td>
                                    <td>
                                        <form class="d-inline" method="GET" action="{{ route('pending.seller') }}" data-toggle="validator" enctype="multipart/form-data">
                                        @csrf
                                            <input type="text" class="form-control" name='seller_id' value='{{ $aes->encrypt($pen->seller_id) }}' hidden>
                                        ...
                                        <button class="btn btn-danger" data-id='{{ $pen->seller_id }}' data-role='delete_seller' title="Delete">
