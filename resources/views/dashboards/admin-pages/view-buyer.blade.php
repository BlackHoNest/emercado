                           ...
                           <div class="col-lg-6">
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input id='province' value="{{ strtoupper($bi->provDesc) }}" class="form-control bg-white fw-bold" readonly>
                                 </div>
                              </div> 
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input id='municipal' value="{{ strtoupper($bi->citymunDesc) }}" class="form-control bg-white fw-bold" readonly>
                                 </div>
                              </div>  
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input id='barangay' value="{{ strtoupper($bi->brgyDesc) }}" class="form-control bg-white fw-bold" readonly>
                                 </div>
                              </div>  
