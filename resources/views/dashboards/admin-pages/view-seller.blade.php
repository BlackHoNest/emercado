                         ...
                         <x-auth-validation-errors class="mb-4" :errors="$errors" />
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input id='province' value="{{ strtoupper($si->provDesc) }}" class="form-control bg-white fw-bold" readonly>
                                 </div>
                              </div> 
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input id='municipal' value="{{ strtoupper($si->citymunDesc) }}" class="form-control bg-white fw-bold" readonly>
                                 </div>
                              </div>  
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input id='barangay' value="{{ strtoupper($si->brgyDesc) }}" class="form-control bg-white fw-bold" readonly>
                                 </div>
                              </div>  
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input id='farmprovince' value="{{ strtoupper($sf->provDesc) }}" class="form-control bg-white fw-bold" readonly>
                                 </div>
                              </div> 
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input id='farmmunicipal' value="{{ strtoupper($sf->citymunDesc) }}" class="form-control bg-white fw-bold" readonly>
                                 </div>
                              </div>  
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input id='farmbarangay' value="{{ strtoupper($sf->brgyDesc) }}" class="form-control bg-white fw-bold" readonly>
                                 </div>
                              </div>    
                                 ...
                                 <div class="form-group">
                                    ...
                                    <ul>
                                       @foreach ($selleraid as $sa)
                                          <li class="fw-bold">{{ strtoupper($sa->AidName) }}</li>
                                       @endforeach
                                    </ul>
                                 </div>
                              </div>  
