                        ...
                        <tbody>
                            ...
                            @foreach ($verifiedsellers as $ver)
                                <tr class='{{ $ver->seller_id }}'>
                                    ...
                                    <td>{{ ucwords($ver->citymunDesc) }}</td>
                                    <td>{{ ucwords($ver->brgyDesc) }}</td>
                                    <td>
                                    <form class="d-inline" method="GET" action="{{ route('view.seller') }}" data-toggle="validator" enctype="multipart/form-data">
                                        @csrf
                                            <input type="text" class="form-control" name='seller_id' value='{{ $aes->encrypt($ver->seller_id) }}' hidden>
                                        ...
                                        <button class="btn btn-danger" data-id='{{ $ver->seller_id }}' data-role='delete_seller' title="Delete">
