                              ...
                              <tr>
                                 ...
                                 <td>
                                    <div class="d-flex align-items-center mb-2">
                                       <h6>{{($top->countBuyer/($confirmed+$unprocess)*100)}}%</h6>
                                    </div>
                                    <div class="progress bg-soft-primary shadow-none w-100" style="height: 4px">
                                       <div class="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="{{($top->countBuyer/($confirmed+$unprocess)*100)}}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                 </td>
                              </tr>
                           @endforeach
